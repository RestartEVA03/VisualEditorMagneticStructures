...
let webglspins, iteration = 0, k;
    ...
    simulateObject = {
        ...
        neighbors: () => {
            ...
            var r_vector = document.getElementById('r_spin');
            var tmp = [];
            var counter;
        ...
        getDirWeb() {
            return simulateObject.spinDirectionsWeb;
        }
    };
...
function getSelectInd(ind){
    ...
    document.getElementById('display-xy').value = "X: " + temp[ind*3].toFixed(3) + " Y: " + temp[ind*3+1].toFixed(3);
}